# JS, 1st, Madlib Assignment

verb1 = input("Choose a verb:\n")
verb2 = input("Choose a verb:\n")
adj1 = input("Choose an adjective:\n")
adj2 = input("Choose an adjective:\n")
waddle = input("Choose an adjective:\n")
lemonade = input("Choose a noun:\n")
grapes = input("Choose a noun:\n")
...
Then he {waddle}d away, {waddle} {waddle}
...
Then he {waddle}d away, {waddle} {waddle}
Then he {waddle}d away, {waddle} {waddle} {waddle}
Then he {waddle}d away, {waddle} {waddle}
'Til the very next day, bum bum bum bum bum ba-dum
